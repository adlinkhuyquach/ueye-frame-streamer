...
execute_process(
  COMMAND "/usr/bin/git" show-ref v3.2.2
  WORKING_DIRECTORY "/workspaces/aea-ueye-frame-streamer/build/xerces-c"
...
if("${show_ref_output}" MATCHES "refs/remotes/v3.2.2")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v3.2.2")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 v3.2.2
  WORKING_DIRECTORY "/workspaces/aea-ueye-frame-streamer/build/xerces-c"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/apache/xerces-c.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/aea-ueye-frame-streamer/build/xerces-c/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/aea-ueye-frame-streamer/build/xerces-c/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
